...
<body>
	...
	%>
	<section style="padding-top: 90px; padding-bottom: 30px">
		<div class="container">
			<div class="row gx-5">
				<aside class="col-lg-6">
					<div class="border rounded-4 mb-3 d-flex justify-content-center">
						...
						<img style="max-width: 100%; max-height: 100vh; margin: auto;"
							class="rounded-4 fit" src="<%=URL%>Image/<%=book.getImage()%>" />
				...
				<main class="col-lg-6">
					<div class="ps-lg-3">
						...
						<div class="mb-3">
							<span class="h5">$ <%=book.getPrice()%></span> <span
								class="text-muted">/ book</span>
						</div>

						<p><%=book.getDescription()%></p>

						<div class="row">
							<dt class="col-3">Auth:</dt>
							<dd class="col-9"><%=book.getAuth()%></dd>

							<dt class="col-3">Color</dt>
							<dd class="col-9">Null</dd>

							<dt class="col-3">Material</dt>
							<dd class="col-9">Paper</dd>
						...
						<a href="#" class="btn btn-primary shadow-0"><i class="me-1 fa fa-heart fa-lg"></i>  Add To WishList
						</a>
						...
						if (user != null) {
						%>
						<a href="cart?book_id=<%=book.getId()%>&&user_id=<%=us.getId()%>"
							class="btn btn-danger border border-secondary py-2 icon-hover px-3">
							 <i
